...
const Brandlist = () => {
  ...
  const fetchBrands = async () => {
    try {
      ...
      const response = await fetch(`${API_BASE_URL}/audibrands?${params}`, {
        method: 'GET',
        headers: {
  ...
  const fetchFeaturedBrands = async () => {
    try {
      ...
      const response = await fetch(`${API_BASE_URL}/audibrands/featured`, {
        method: 'GET',
        headers: {
          'Content-Type': 'application/json',
          'Authorization': `Bearer ${localStorage.getItem('token') || ''}`,
  ...
  const toggleBrandStatus = async (brandId) => {
    try {
      const response = await fetch(`${API_BASE_URL}/audibrands/${brandId}/toggle-status`, {
        method: 'PATCH',
        headers: {
          'Content-Type': 'application/json',
          'Authorization': `Bearer ${localStorage.getItem('token') || ''}`,
  ...
  const deleteBrand = async (brandId) => {
    ...
    try {
      const response = await fetch(`${API_BASE_URL}/audibrands/${brandId}`, {
        method: 'DELETE',
        headers: {
          'Content-Type': 'application/json',
          'Authorization': `Bearer ${localStorage.getItem('token') || ''}`,
  ...
  const createBrand = async () => {
    try {
      ...
      const response = await fetch(`${API_BASE_URL}/audibrands`, {
        method: 'POST',
        headers: {
          'Authorization': `Bearer ${localStorage.getItem('token') || ''}`,
        },
